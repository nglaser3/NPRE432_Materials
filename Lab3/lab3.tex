...
\Fig{q2.png}{Linear regression to predict maximum achievable yield strength}{fig:q2}
...
\Fig{q3.png}{Hardness as a function of Annealing temperature}{fig:hardtemp}
